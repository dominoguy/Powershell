...
Get-ADUser -Filter {employeeNumber -like '*' -And Enabled -eq $True} -SearchBase $domain -ResultPageSize 0 -Property Employeenumber,Surname,GivenName,physicalDeliveryOfficeName,Title,Department,lastLogon | Select-Object Employeenumber,Surname,GivenName,physicalDeliveryOfficeName,Title,Department,{[datetime]::FromFileTime( $_.lastLogon)} | Export-CSV -NoType $ADUserFile
$Header = 'Employee','LastName','FirstName','Facility','Department','Title','LastLogon'
